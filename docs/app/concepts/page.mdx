...
A `Policy` is a stable rule definition. It has an `id`, `name`, `instruction`, and denial `message`.
...
const policy = new Policy({
  ...
  message: "Custom contract terms need approval.",
});
```
...
new Policy({
  ...
  message: "This request needs review.",
  confidence: 0.8,
});
```
...
new Policy({
  ...
  message: "Commercial terms need review.",
  escalation: {
    maxConfidence: 0.65,
    policies: [
      {
        ...
        message: "Pricing exceptions need approval.",
      },
    ],
  },
});
